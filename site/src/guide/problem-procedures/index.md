...
The answer to your question will sometimes be "you can't" if we feel it goes against the [design of Stello](/guide/design/). We are always open to feedback though, so feel free to try change our mind if you have compelling reasons.
...
It is common to want to center headings. Instead, consider creating a banner image (with text overlayed) for your message or section which will be more visually appealing. [Generic professional photographs](https://unsplash.com/) can be added to Stello within moments simply by copying and pasting.
