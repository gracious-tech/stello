...
If your messages are getting opened at a lower rate than you expect, please first [read our page on low open rates](/guide/problem-opens/). If you have confirmed that your messages are definitely getting marked as spam for some recipients, you can reduce the chance of this by:

 1. Getting recipients to mark the email as __"not spam"__ (when it has gone to spam)
 2. Personalise the message's invitation, which is the box above the actual Stello message when editing it as a draft. This is the text that is inserted into the email. It should be:
    1. __Substantial:__ Add a paragraph or two about what's in your newsletter
    2. __Specific:__ Add text specific to you, not just generic text about opening the newsletter
    3. __Normal:__ Write it like a normal email and avoid language or formatting that can trigger spam filters — for example, excessive exclamation marks (!), ALL CAPS, or overly promotional wording.
 3. Get recipients to save your address as a contact __in their email app__
